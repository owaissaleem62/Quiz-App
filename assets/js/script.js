        ...
        quiz['options'].forEach((option,index)=>{
            ...
            if(quiz['selected_answer'] == quiz['answer']){
                if(index+1 == quiz['answer']){
                    option_container.innerHTML += `<p class="result-option correct2">${option} <span>You</span></p>`
                }else{
                    option_container.innerHTML += `<p class="result-option">${option}</p>`
                }
            }else{
                if(index+1 == quiz['answer']){
                    option_container.innerHTML += `<p class="result-option correct2">${option} <span>Correct</span></p>`
                }else if(index+1 == quiz['selected_answer']){
                    option_container.innerHTML += `<p class="result-option wrong2">${option} <span>You</span></p>`
                }else{
                    option_container.innerHTML += `<p class="result-option">${option}</p>`
                }
            }
